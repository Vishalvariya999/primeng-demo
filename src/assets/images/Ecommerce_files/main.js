...
const routes = [{
  path: 'auth',
  loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_features_auth_auth_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! src/app/features/auth/auth.module */ 2399)).then(m => m.AuthModule)
}, {
  path: '**',
  redirectTo: 'auth'
}];
